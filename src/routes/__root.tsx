...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Maddy Marín's Portfolio showcases her skills as a Software Engineering student." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Maddy Marín's Portfolio showcases her skills as a Software Engineering student." },
